...
class Fullcb extends Payzen
{
    ...
    public function __construct(
        ...
        \Lyranetwork\Payzen\Model\FullcbConfigProvider $configProvider,
        array $data = []
    ) {
        parent::__construct($context, $dataHelper, $configProvider, \Lyranetwork\Payzen\Helper\Data::METHOD_FULLCB, $data);
    }

    public function getAvailableOptions()
    {
        return $this->getConfig()['availableOptions'];
    }
}