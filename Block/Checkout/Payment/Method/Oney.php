...
class Oney extends Payzen
{
    ...
    public function __construct(
        ...
        \Lyranetwork\Payzen\Model\OneyConfigProvider $configProvider,
        array $data = []
    ) {
        parent::__construct($context, $dataHelper, $configProvider, \Lyranetwork\Payzen\Helper\Data::METHOD_ONEY, $data);
    }
