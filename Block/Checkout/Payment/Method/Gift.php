...
class Gift extends Payzen
{
    ...
    public function __construct(
        ...
        \Lyranetwork\Payzen\Model\GiftConfigProvider $configProvider,
        array $data = []
    ) {
        parent::__construct($context, $dataHelper, $configProvider, \Lyranetwork\Payzen\Helper\Data::METHOD_GIFT, $data);
    }
