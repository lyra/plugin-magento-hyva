...
use \Lyranetwork\Payzen\Model\OneyConfigProvider as ConfigProvider;
...
class Oney extends Payzen
{
    public function __construct(
        ...
        parent::__construct($checkoutSession, $cartRepository, $configProvider, \Lyranetwork\Payzen\Helper\Data::METHOD_ONEY);
    }
}