...
use \Lyranetwork\Payzen\Model\SepaConfigProvider as ConfigProvider;
...
class Sepa extends Payzen
{
    public function __construct(
        ...
        parent::__construct($checkoutSession, $cartRepository, $configProvider, \Lyranetwork\Payzen\Helper\Data::METHOD_SEPA);
    }
}